...
--Создание таблицы с препаратами. Связь с таблицей с видами препаратов (один ко многим)
...
--Создание таблицы с продажами. Связь с таблицами с препаратами, сотрудниками, клиентами (один ко многим)
...
--Создание таблицы с сотрудниками. Связь с таблицей с должностями (один ко многим)
...
--Создание таблицы с поставками Связь с таблицей с препаратами (один ко многим)
